...
const { AEMUpload } = require("./es2015");
...
function main() {
    ...
    return aemUpload.uploadFiles({
        uploadFiles: [{
            fileUrl: "http://localhost:4502/content/dam/bulkupload7/simon-fitall-tvleqH3p1os-unsplash.jpg",
            fileSize: 11806152,
            filePath: "/Users/bmanen/Pictures/unsplash/simon-fitall-tvleqH3p1os-unsplash.jpg"
        }, {
            fileUrl: "http://localhost:4502/content/dam/bulkupload7/sid-ramirez-xF2HkuitGDY-unsplash.jpg",
            fileSize: 3253102,
            filePath: "/Users/bmanen/Pictures/unsplash/sid-ramirez-xF2HkuitGDY-unsplash.jpg"
        }, {
            fileUrl: "http://localhost:4502/content/dam/bulkupload7/shawnn-tan-9ZidPkO9qv0-unsplash.jpg",
            fileSize: 1892021,
            filePath: "/Users/bmanen/Pictures/unsplash/shawnn-tan-9ZidPkO9qv0-unsplash.jpg"
        }, {
            fileUrl: "http://localhost:4502/content/dam/bulkupload7/alexunder-hess-fXaruvd6Oio-unsplash.jpg",
            fileSize: 683019,
