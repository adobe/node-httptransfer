...
const { BlockRequestGenerator } = require("../../lib/asset/blockrequestgenerator");

describe("BlockRequestGenerator", () => {
    function createPart() {
    ...
    it("test create transfer part http body", function () {
        const request = new BlockRequestGenerator();
        const part = createPart();
        assert.strictEqual(request.createPartHttpBody({
            transferPart: part,
            partData: "Hello World!"
        }), "Hello World!");
    });
    ...
    it("test create transfer part http headers with buffer", function () {
        const request = new BlockRequestGenerator();
        const part = createPart();
        assert.deepStrictEqual(request.createPartHttpHeaders({
            transferPart: part,
