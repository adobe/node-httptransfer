...
const { TransferMemoryBlock, TransferMemoryBuffer } = require("./transfer-memory-allocator");
...
class RandomFileAccess {
     ...
     */
    constructor(bufferMemoryAllocator) {
        this[PRIVATE] = {
            fileHandles: new Map()
        };

        this[PRIVATE].bufferMemoryAllocator = null;
        if(bufferMemoryAllocator){
            console.log(`############ TMN - Using buffer pool memory allocator`);
            this[PRIVATE].bufferMemoryAllocator = bufferMemoryAllocator;
        }
    }
    ...
    async close(path) {
        ...
        // TODO: Should we ensure all used buffer parts get released cleanly too?
        this[PRIVATE].bufferMemoryAllocator = null;
    }
    ...
    async read(path, range) {
        ...
        console.log('~~~~~~~~~~~~~~~~~~ read##Buffer memory block:')
        console.log(bufferMemoryBlock)
        console.log('~~~~~~~~~~~~~~~~~~')

        console.log('~~~~~~~~~~~~~~~~~~ read##Memory from buffer pool:')
        console.log(this[PRIVATE].bufferMemoryAllocator.dumpBufferBlockUsedMemory())
        console.log('~~~~~~~~~~~~~~~~~~')

        console.log('~~~~~~~~~~~~~~~~~~ read##Pending allocations from buffer pool:')
        console.log(this[PRIVATE].bufferMemoryAllocator.dumpWaitingAllocations())
        console.log('~~~~~~~~~~~~~~~~~~')
        ...
        console.log(bufferMemoryBlock.buffer)
        console.log("~~~~~~~~~~~~~~~~~~ ")
    ...
    releaseFileBufferMemory(bufferMemoryBlock){
        console.log('~~~~~~~~~~~~~~~~~~ releaseFileBufferMemory##Buffer memory block:')
        console.log(bufferMemoryBlock)
        console.log('~~~~~~~~~~~~~~~~~~')

        console.log('~~~~~~~~~~~~~~~~~~ releaseFileBufferMemory##Memory from buffer pool:')
        console.log(this[PRIVATE].bufferMemoryAllocator.dumpBufferBlockUsedMemory())
        console.log('~~~~~~~~~~~~~~~~~~')

        console.log('~~~~~~~~~~~~~~~~~~ releaseFileBufferMemory##Pending allocations from buffer pool:')
        console.log(this[PRIVATE].bufferMemoryAllocator.dumpWaitingAllocations())
        console.log('~~~~~~~~~~~~~~~~~~')
