 ...
 * @property {Function} retryOnHttpResponseError Optional function determining whether to retry given the HttpResponseError (defuaults to false)
 */
...
function retryOn(attempt, error, options) {
    if (options) {
        ...
        // if function provided, determine whether to retry given the HttpResponseError
        if (options.retryOnHttpResponseError && (error instanceof HttpResponseError)) {
