 ...
 */
/**
 * Describes the (partial) source of content transfer.
 */
class Source {
    /**
     * Construct a transfer source object.
     * 
    ...
    * @param {number} [totalSize] Total size of the content in bytes
     */
    constructor(uri, contentType, lastModified, etag, offset, size, totalSize) {
     ...
     * 
     * @returns {Number} Size of the block in bytes, or undefined
     */
    get size() {
