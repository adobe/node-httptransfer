    ...
    async* execute(transferAssets, controller) {
        for await (const transferAsset of transferAssets) {
            try {
                ...
                // notify
                controller.emit(TransferEvents.BEFORE_COMPLETE_UPLOAD, {
                    transferAsset
                });
                ...
                // notify
                controller.emit(TransferEvents.AFTER_COMPLETE_UPLOAD, {
                    transferAsset
                });
    
                yield transferAsset;
            } catch (e) {
                console.error(`Failed to complete ${transferAsset.target.url}`, e);
