        ...
        for await (const transferPart of transferParts) {
            ...
            try {
                ...
                if (isFileProtocol(transferPart.source.url) && targetUrl) {
                    ...
                    console.log('~~~~~~~~~~~~~~~~~~ transfer##execute Buffer memory block:')
                    console.log(bufferMemoryBlock)
                    console.log('~~~~~~~~~~~~~~~~~~')
                    console.log('~~~~~~~~~~~~~~~~~~ transfer##execute buf:')
                    console.log(bufferMemoryBlock.buffer.length)
                    console.log('~~~~~~~~~~~~~~~~~~')
                    ...
                    console.log(`############ TMN - Done with the part`);
