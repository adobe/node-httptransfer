    ...
    async* execute(transferAssets, controller) {
        for await (const transferAsset of transferAssets) {
            try {
                ...
                console.log(`~~~~~~~~~~~~ Transfer asset metadata: `);
                console.log(JSON.stringify(transferAsset.metadata));
                console.log(`~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`);
                if (transferAsset.acceptRanges && transferAsset.multipartTarget) {
                    console.log("Ranges accepted - creating parts accordingly");
                    ...
                    for (const range of generatePartRanges(contentLength, partSize)) {
                        ...
                        console.log(JSON.stringify(transferPart));
                        console.log(`~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~`);
                    ...
                    console.log("Ranges accepted, protocol is file - creating parts accordingly");
                    ...
                    console.log("No ranges accepted");
                    const targetUrls = [transferAsset.target.url];
