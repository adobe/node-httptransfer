...
class AssetMultipart {
    ...
    constructor(targetUrls, minPartSize, maxPartSize, headers, completeUrl, uploadToken) {
        if (!Array.isArray(targetUrls) || (targetUrls.length === 0)) {
            throw new IllegalArgumentError("Invalid target urls", targetUrls);
        ...
        } else if (completeUrl && !(completeUrl instanceof URL) && (typeof completeUrl !== "string")) {
            throw new IllegalArgumentError("Invalid completeUrl", completeUrl);
        }
        this[PRIVATE] = {
            targetUrls,
            minPartSize,
