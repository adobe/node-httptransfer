...
class NameConflictPolicy {
    ...
    static createVersionPolicy(versionLabel, versionComment) {
        if (versionLabel && (typeof versionLabel !== "string")) {
            throw new IllegalArgumentError("versionLabel is expected to be a string", versionLabel);
        }
        if (versionComment && (typeof versionComment !== "string")) {
            throw new IllegalArgumentError("versionComment is expected to be a string", versionComment);
        }
        return new NameConflictPolicy({
            createVersion: true,
            versionLabel,
