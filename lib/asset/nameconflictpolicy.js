...
class NameConflictPolicy {
    ...
    constructor(options) {
        if (options && options.versionLabel && (typeof options.versionLabel !== "string")) {
            throw Error(`versionLabel is expected to be a string: ${options.versionLabel}`);
        }
        if (options && options.versionComment && (typeof options.versionComment !== "string")) {
            throw Error(`versionComment is expected to be a string: ${options.versionComment}`);
        }
        this[PRIVATE] = {
