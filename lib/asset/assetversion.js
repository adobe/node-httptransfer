...
class AssetVersion {
    ...
    constructor(lastModified, etag) {
        if (lastModified && !isValidNumber(lastModified)) {
            throw new IllegalArgumentError("Invalid lastModified", lastModified);
        }
        if (etag && (typeof etag !== "string")) {
            throw new IllegalArgumentError("Invalid etag", etag);
        }
        this[PRIVATE] = {
            lastModified,
            etag
