...
class TransferPart {
    ...
    /**
     * Creates the body that will be used for the part when transferred via HTTP.
    ...
    createPartHttpBody(partInfo) {
        // default implementation uses the data itself.
        const { partData } = partInfo;
        return partData;
    }

    /**
     * Creates the headers that will be used for the part when transferred via HTTP.
