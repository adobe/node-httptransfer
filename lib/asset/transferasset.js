...
class TransferAsset {
    ...
    /**
     * Sets the total amount of time, in milliseconds, that it took for the asset to transfer
     * in its entirety.
     *
     * @param {number} duration Number of milliseconds.
     */
    setUploadDuration(duration) {
        this[PRIVATE].uploadDuration = duration;
    }

    /**
     * Retrieves the total amount of time, in milliseconds, that it took for the asset to
     * transfer. Will be 0 if no duration has been specified.
     *
     * @returns {number} Number of milliseconds.
     */
    get uploadDuration() {
        return this[PRIVATE].uploadDuration || 0;
    }
