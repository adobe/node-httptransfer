...
class CreateAssetServletUpload extends AEMBinaryUpload {
     ...
     */
    getTransferOptions() {
        // overridden to ensure that parts are POSTed to the create asset
        // servlet
        return {
            ...super.getTransferOptions(),
    ...
    getPreferredPartSize() {
        const defaultSize = super.getPreferredPartSize();
    ...
    getPipelineSteps(randomFileAccess) {
        ...
        return [
            ...
            new MapConcurrent(new Transfer(randomFileAccess, transferOptions), { maxConcurrent: this.getMaxConcurrent() }),
    ...
    createTransferController() {
        // uses a different transfer controller to ensure that parts are
        // formatted correctly when uploaded.
        return new CreateAssetServletController();
    }
}
