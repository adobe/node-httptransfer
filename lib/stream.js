    ...
    return new Promise((resolve, reject) => {
        response.body
            ...
            .on("finish", () => {
                ...
                //
                // NOTE: as of June, 2024, fetch is included in node.js core, so node-fetch-npm was removed. Leaving this check in
                // place in case stream error event handling has not been fixed.
