...
function getSize(headers) {
    ...
    //     const unzipped = await gunzip(contentLength);
    //     console.log('unzipped length:', unzipped.length);
    // }
    console.log('-------------------------------- Headers:');
    console.log(JSON.stringify(headers));
    console.log('transfer encoding:', headers.get('transfer-encoding'));
    console.log('content encoding:', contentEncoding);
    console.log('content length:', contentLength);
    console.log('parsed content range:', parsed);
