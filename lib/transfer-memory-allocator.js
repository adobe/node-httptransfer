...
const MAX_PERCENTAGE_ALLOWED_MEMORY_USE = 0.5; // 50%
const DEFAULT_TRANSFER_BUFFER_POOL_SIZE = 50 * 1024 * 1024; // 50 Mb
...
class TransferMemoryBuffer {
    ...
    constructor(suggestedSize) {
        ...
        console.log(`Available free memory is ${availableFreeMemory} bytes`);

        const processMemoryState = process.memoryUsage();
        console.log(`~~~~~~~~~~ Process memory state is:`);
        console.log(processMemoryState);
        console.log(`~~~~~~~~~~ Process memory state is:`);
