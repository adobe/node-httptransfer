...
class TransferMemoryBuffer {
    ...
    constructor(suggestedSize, allowDeferredAllocations="true") {
        ...
        const availableFreeMemory = os.freemem(); // TODO-TMN: Get true available memory for Docker Linux container by reading `/sys/fs/cgroup/memory/memory.limit_in_bytes` if available
