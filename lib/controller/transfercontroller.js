...
class TransferController extends EventEmitter {
    ...
    /**
     * Creates a new instance of a TransferPart for transferring an asset's data.
     * 
     * @param {TransferAsset} transferAsset Asset to which the part belongs.
    ...
    createTransferPart(transferAsset, targetUrls, contentRange, targetHeaders = {}) {
        return new TransferPart(transferAsset, targetUrls, contentRange, targetHeaders);
    }
}
