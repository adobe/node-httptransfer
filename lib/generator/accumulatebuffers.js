...
/**
 * Splits and accumulates buffers in to fixed size buffers.
 *
 * Once a buffer of the given `partSize` is constructed, it is pushed
 * to the given queue or array.
 */
class AccumulateBuffers {
    /**
     * Construct a buffer accumulator.
     *
