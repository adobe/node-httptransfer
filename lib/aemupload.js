...
function createFileEvent(transferAsset) {
    return {
        fileName: decodeURI(urlPathBasename(transferAsset.target.url.pathname)),
        fileSize: transferAsset.metadata.contentLength,
        targetFolder: decodeURI(urlPathDirname(transferAsset.target.url.pathname)),
        targetFile: decodeURI(transferAsset.target.url.pathname),
