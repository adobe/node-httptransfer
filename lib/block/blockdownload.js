...
const DEFAULT_PART_SIZE = 10 * 1024 * 1024; // Default part size for download is 10mb
...
class BlockDownload extends EventEmitter {
    ...
    finalizeController(controller){
        ...
        try {
            ...
            console.log(`Failed to remove event listeners from block download controller: ${JSON.stringify(err)}`);
        }
    }
