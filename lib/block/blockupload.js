 ...
 */
 async function* generateBlockUploadTransfer(options) {
    for (const uploadFile of options.uploadFiles) {
        ...
        const uploadURIs = options.fileUrl;
        const minPartSize = options.minPartSize || 10;
...
class BlockUpload extends EventEmitter {
    ...
    async uploadFiles(options) {
        ...
        controller.on(TransferEvents.AEM_INITIATE_UPLOAD, transferEvent => {
            console.log("filestart", transferEvent.transferAsset.eventData);
        ...
        controller.on(TransferEvents.AFTER_AEM_COMPLETE_UPLOAD, transferEvent => {
            console.log("fileend", transferEvent.transferAsset.eventData);
