...
class BlockUpload extends EventEmitter {
    ...
    */
    ...
    async uploadFiles(options = {}) {
        ...
        console.log(`############ TMN - Preferred block part size is ${preferredPartSize}, concurrency is ${maxConcurrent}`);
        const blockDownloadBufferAllocator = new TransferMemoryBuffer((preferredPartSize * maxConcurrent) + preferredPartSize);
