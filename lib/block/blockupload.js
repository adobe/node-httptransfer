...
async function* generateBlockUploadTransfer(options) {
    ...
    for (const uploadFile of options.uploadFiles) {
        ...
        console.log(`Transfer asset to upload is of content type ${contentType}`);
...
class BlockUpload extends EventEmitter {
    ...
    createBlockUploadController() {
        ...
        console.log("Block upload: block upload controller created");
        return controller;
    }
    ...
    */
    ...
    async uploadFiles(options = {}) {
        ...
        try {
            ...
            console.log("Block upload: executing block download pipeline");
            await executePipeline(pipeline, generateBlockUploadTransfer(options), controller);
            console.log("Block upload: finished executing block download pipeline");
            ...
            if (this.errorEvents && this.errorEvents.length > 0) {
                ...
                console.log("Errors encountered during block upload");
            ...
            if (randomFileAccess) {
                console.log("Block upload: closing random file accessor");
