    ...
    */
    ...
    async uploadFiles(options = {}) {
        ...
        if(options && options.uploadFiles && options.uploadFiles.length > 0){
            let minMultipartPartSize = Number.MAX_SAFE_INTEGER;
        ...
        console.log(`blockupload### minMemoryBlockSize: ${minMemoryBlockSize}, maxConcurrent: ${maxConcurrent}`);
        console.log(options);

        const blockDownloadBufferAllocator = new TransferMemoryBuffer(minMemoryBlockSize * maxConcurrent);
