...
const DEFAULT_PART_SIZE = 10 * 1024 * 1024; // Default part for upload size is 10mb
...
class BlockUpload extends EventEmitter {
    ...
    */
    ...
    async uploadFiles(options) {
        ...
        /*
        // Option 1:
        Memory check to do: preferredPartSize*maxConcurrent vs available memory as safety check,
        reduce concurrency to a safer level
        // Option 2:
        Just reduce `maxConcurrent` => try 5, see what happens in tests
        */
        ...
        const randomFileAccess = new RandomFileAccess(minMemoryBlockSize, maxConcurrent);
        try {
